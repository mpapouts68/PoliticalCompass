-- Systematically fix ALL PM scenarios one by one to ensure perfect matching

-- Clear all existing options first
DELETE FROM pm_decisions;
DELETE FROM pm_policy_options;

-- Scenario 1: Οικονομική Κρίση: Αύξηση Ανεργίας (Economic Crisis: Rising Unemployment)
-- Description: Η ανεργία έχει φτάσει στο 15% και αυξάνεται ραγδαία. Οι πολίτες διαδηλώνουν και ζητούν άμεσα μέτρα.
...
-- Description: Η εγκληματικότητα έχει αυξηθεί κατά 25% τον τελευταίο χρόνο. Οι πολίτες ζητούν δράση. Οι αστυνομικοί είναι υποστελεχωμένοι.
INSERT INTO pm_policy_options (scenario_id, option_text, option_text_en, political_cost, economic_impact, social_impact, party_alignment, consequences, consequences_en) VALUES 
...
-- Description: Τουρκικά πλοία παραβιάζουν την ΑΟΖ. Οι σύμμαχοι ζητούν αυτοσυγκράτηση. Η κοινή γνώμη ζητά δράση.
INSERT INTO pm_policy_options (scenario_id, option_text, option_text_en, political_cost, economic_impact, social_impact, party_alignment, consequences, consequences_en) VALUES 
...
-- Description: Μεγάλη φωτιά απειλεί τουριστικές περιοχές. Χρειάζονται άμεσα ευρωπαϊκά μέσα πυρόσβεσης. Εκκενώσεις σε εξέλιξη.
INSERT INTO pm_policy_options (scenario_id, option_text, option_text_en, political_cost, economic_impact, social_impact, party_alignment, consequences, consequences_en) VALUES 
...
-- Description: Οι γιατροί απεργούν για μισθούς και συνθήκες εργασίας. Τα νοσοκομεία δυσκολεύονται να λειτουργήσουν.
INSERT INTO pm_policy_options (scenario_id, option_text, option_text_en, political_cost, economic_impact, social_impact, party_alignment, consequences, consequences_en) VALUES 
